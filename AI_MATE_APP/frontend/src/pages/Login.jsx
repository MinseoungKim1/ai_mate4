      ...
      <div style={authCardStyle}>
        ...
        {isNewUser ? (
          <div style={formStyle}>
            ...
            {/* 💡 [추가] 가입 화면에서 로그인으로 돌아가기 버튼 */}
            <p style={toggleTextStyle} onClick={handleBackToLogin}>
              이미 계정이 있으신가요? <span style={highlightStyle}>로그인</span>
            </p>
          </div>
        ) : (
          <>
            ...
            <p style={toggleTextStyle} onClick={handleGeneralSignup}>
              아직 계정이 없으신가요?{" "}
